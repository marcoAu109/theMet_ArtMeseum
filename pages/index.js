...
export default function Home() {
  ...
  let paragraphy4 = "The information ";
  return (
    <>
      <Container>
        <Row>
        ...
        <Row>
          ...
          <Col md={6}>
            ...
            <a
              href="https://www.metmuseum.org/about-the-met"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <Container>
        <footer>
          <Col md={{ span: 3, offset: 9 }}>© 2023 Marco Au <EnvelopeAt /> <Link href="mailto:marcoau28@gmail.com" passHref legacyBehavior >Email</Link></Col>
        </footer>
      </Container>
    </>
  );
